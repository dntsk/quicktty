...
- ручной first-party artwork без новых зависимостей.

Сначала создаётся preview 1024×1024. Полный appiconset экспортируется только после визуального подтверждения.
