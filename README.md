...
QuickTTY can check for stable updates in the app. An opt-in beta channel is also available; see the [release channels](https://quicktty.app/releases/) page for details. The current beta is [0.1.4.beta-1](https://github.com/dntsk/quicktty/releases/download/v0.1.4.beta-1/QuickTTY-0.1.4.beta-1-arm64.dmg).
