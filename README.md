...
Перед выпуском нужны полная Xcode в `DEVELOPER_DIR` (по умолчанию `/Applications/Xcode.app/Contents/Developer`), сертификат Developer ID Application вашей команды и заранее сохранённый профиль Keychain `ghostterm-notary`.
