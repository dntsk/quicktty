...
copy_for_build_context() {
    build_root=$1
    fixture_resources=$build_root/GhostTerm.app/Contents/Resources
...
expect_failure sh "$copy_script" /Applications/GhostTerm.app /Applications/GhostTerm.app

missing_root=$tmp_root/missing-source-repository
missing_destination=$missing_root/build/GhostTerm.app/Contents/Resources
...
mismatched_resources=$tmp_root/Mismatched/Build/Products/Debug/GhostTerm.app/Contents/Resources
other_expected_resources=$tmp_root/Mismatched/Build/Products/Release/GhostTerm.app/Contents/Resources
...
linked_resources=$tmp_root/LinkedResources/Build/Products/Debug/GhostTerm.app/Contents/Resources
...
copy_for_build_context "$tmp_root/Library/Developer/Xcode/DerivedData/GhostTerm-test/Build/Products/Debug"
copy_for_build_context "$tmp_root/archives/GhostTerm.xcarchive/Products/Applications"

symlink_resources=$tmp_root/SymlinkTargets/Build/Products/Debug/GhostTerm.app/Contents/Resources
...
signal_resources=$tmp_root/Signal/Build/Products/Debug/GhostTerm.app/Contents/Resources
create_stale_resources "$signal_resources"
signal_status=0
GHOSTTERM_TEST_SEND_TERM_AFTER_TERMINFO_BACKUP=1 \
